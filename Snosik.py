...
def print_menu():
    ...
    print(Fore.LIGHTCYAN_EX + "        •  shop - @artemseller")
    print(Fore.LIGHTRED_EX + "")
    print(Fore.LIGHTCYAN_EX + "   Меню")
    print(Fore.LIGHTCYAN_EX + "   1. Снос по почте " + Fore.LIGHTCYAN_EX + "[ " + Fore.LIGHTGREEN_EX + "UNWORK" + Fore.LIGHTCYAN_EX + "]")
    print(Fore.LIGHTCYAN_EX + "   2. Снос через сайт WORK")
    print(Fore.LIGHTCYAN_EX + "   3. Снос через телеграм ")
...
def handle_session_complaint():
    ...
    channel_username = input(Fore.LIGHTCYAN_EX + "   Введите username акка: " + Fore.RESET)
    text = input(Fore.LIGHTCYAN_EX + "   Введите текст жалобы: " + Fore.RESET)
